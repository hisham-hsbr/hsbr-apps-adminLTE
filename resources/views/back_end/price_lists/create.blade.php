...
@section('mainContent')
    ...
    <form role="form" action="{{ route('priceLists.store') }}" method="post" enctype="multipart/form-data" id="quickForm">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-4">
                    <x-form.form-group-label-input label_for="uom" label_name="Uom" input_type="text" input_name="uom"
                        ...
                        input_value="{{ old('uom') }}" input_placeholder="Enter uom" />
                </div>
                <div class="col-2">
            ...
            <div class="col-2">
                <x-form.form-group-checkbox-label input_type="checkbox" input_name="status" input_class=""
                    input_style="" input_id="status" input_value="1" input_add="" label_for="status"
                    label_name="Active" />
            </div>
        </div>
