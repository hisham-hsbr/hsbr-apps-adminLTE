                ...
                <div class="dropdown-menu border border-300 font-base start-0 py-0 overflow-hidden w-100">
                  <div class="scrollbar-overlay" style="max-height: 30rem;">
                    <div class="list pb-3">
                      ...
                      <div class="py-2"><a class="dropdown-item" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                        ...
                        <a class="dropdown-item" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                          <div class="d-flex align-items-center">
                      ...
                      <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                          <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3" src="{{ asset('back-end-links/phoenix/public/assets/img/products/60x60/3.png') }}" alt="" /></div>
                          <div class="flex-1">
                            <h6 class="mb-0 text-1000 title">MacBook Air - 13″</h6>
                            <p class="fs--2 mb-0 d-flex text-700"><span class="fw-medium text-600">8GB Memory - 1.6GHz - 128GB Storage</span></p>
                          </div>
                        </a>
                        <a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                          <div class="file-thumbnail me-2"><img class="img-fluid" src="{{ asset('back-end-links/phoenix/public/assets/img/products/60x60/3.png') }}" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/public/pages/members.html') }}">
                          <div class="avatar avatar-l status-online  me-2 text-900">
                            <img class="rounded-circle " src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/10.webp') }}" alt="" />
                        ...
                        <a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/public/pages/members.html') }}">
                          <div class="avatar avatar-l  me-2 text-900">
                            <img class="rounded-circle " src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/12.webp') }}" alt="" />
