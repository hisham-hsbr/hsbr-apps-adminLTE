...
class DeveloperSettingsController extends Controller
{
    ...
    {
        $developerSettingss = DeveloperSettings::all();
        return view('folder.DeveloperSettingss.folder',compact('DeveloperSettingss'))->with('i');
    }
     ...
     */
    public function update(Request $request, DeveloperSettings $developerSettings)
    {
        //
    }
