...
class DeveloperSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DeveloperSettings::create(['name' => 'page' ,'data'=>['page_title_prefix'=>'HSBR-App','page_suffix'=>'apps','page_description' => 'default description'], 'description' => 'app des' ,'parent'=>'default', 'status' => '1' , 'created_by' => '1' , 'updated_by' => '1']);
